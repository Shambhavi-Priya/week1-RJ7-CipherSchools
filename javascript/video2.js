...
// ************** object matching ***********
// let obj1 = {name:"shambhavi"};
// let obj2 ={name : "shambhavi"};
...
// map.set(2, "riya");
//console.log(map);
// output:- Map(2) { 1=>'shambhavi', 2 => 'riya' }
...
// console.log(map.values());//{ 'shambhavi', 'riya' }
...
let  animal = new Animal(4,"blue", "rodent " , "moooo");
console.log(animal);
animal.showAnimal();